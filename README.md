...
## Radio playlist format

List MP3 paths in `music/tracks.json` as strings or objects. Example:

```json
[
  "assets/music/eternal-justice.mp3"
]
```

The player also supports objects such as `{ "title": "Eternal Justice", "file": "assets/music/eternal-justice.mp3" }`.

## Newest members

The newest-member board uses the Chess.com Public API. It loads each member's profile picture and displays the highest available recorded rating among Rapid, Blitz, Bullet, and Daily.
